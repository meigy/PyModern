...
namespace FirstFloor.ModernUI.App.Content
{
        ...
        : NotifyPropertyChanged
    {
        ...
        public SettingsAppearanceViewModel()
        {
            ...
            this.themes.Add(new Link { DisplayName = "bing image", Source = new Uri("/FirstFloor.ModernUI.App;component/Assets/ModernUI.BingImage.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "hello kitty", Source = new Uri("/FirstFloor.ModernUI.App;component/Assets/ModernUI.HelloKitty.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "love", Source = new Uri("/FirstFloor.ModernUI.App;component/Assets/ModernUI.Love.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "snowflakes", Source = new Uri("/FirstFloor.ModernUI.App;component/Assets/ModernUI.Snowflakes.xaml", UriKind.Relative) });
