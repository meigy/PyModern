...
namespace IronPython.Hosting {
    ...
    public partial class NewPythonCommandLine : CommandLine {
        ...
        public new PythonConsoleOptions Options { get { return (PythonConsoleOptions)base.Options; } }
        
        public NewPythonCommandLine() {
        }
        ...
        public static string GetLogoDisplay() {
            return PythonContext_GetVersionString +
        ...
        protected override int Run() {
            if (Options.ModuleToRun != null) {
                ...
                try {
                    runMod = PythonOps.GetBoundAttr(PythonContext_SharedContext, runpy, "run_module");
                } catch (Exception) {
        ...
        protected override void Initialize() {
            ...
            Console.Output = new NewOutputWriter(PythonContext, false);
            Console.ErrorOutput = new NewOutputWriter(PythonContext, true);
            
            // TODO: must precede path initialization! (??? - test test_importpkg.py)
            int pathIndex = PythonContext_PythonOptions.SearchPaths.Count;
            ...
            PythonContext_InsertIntoPath(0, fullPath);
#if FEATURE_THREAD
            ...
            if (!Options.IgnoreEnvironmentVariables) {
                ...
                if (path != null && path.Length > 0) {
                    ...
                    foreach (string p in paths) {
                        PythonContext_InsertIntoPath(pathIndex++, p);
                    }
                }
            }
#endif
        ...
        private void InitializeEnvironmentVariables() {
            ...
            if(!Options.IgnoreEnvironmentVariables) {
                ...
                object o = PythonContext_GetSystemStateValue("warnoptions");
                if (o == null) {
                    o = new List();
                    PythonContext_SetSystemStateValue("warnoptions", o);
                }
        ...
        private void InitializeModules() {
            ...
            PythonContext_SetHostVariables(prefix ?? "", executable, null);
        ...
        private void ImportSite() {
            ...
            try {
                Importer.ImportModule(PythonContext_SharedContext, null, "site", false, -1);
            } catch (Exception e) {
                Console.Write(Language.FormatException(e), Style.Error);
            }
        }
        ...
        protected override ErrorSink/*!*/ ErrorSink {
            get { return NewThrowingErrorSink.Default; }
        }
        ...
        private int RunCommandWorker(string command) {
            ...
            ModuleOptions trueDiv = (PythonContext_PythonOptions.DivisionOptions == PythonDivisionOptions.New) ?
        ...
        private int RunFileWorker(string/*!*/ fileName) {
            try {
                ...
                object importer;
                if (Importer_TryImportMainFromZip(DefaultContext.Default, fileName, out importer)) {
                    return 0;
                }
        ...
        public override IList<string> GetGlobals(string name) {
            ...
            foreach (object builtinName in PythonContext_BuiltinModuleInstance___dict__.Keys) {
        ...
        protected override void UnhandledException(Exception e) {
            PythonOps.PrintException(PythonContext_SharedContext, e, Console);
        }
