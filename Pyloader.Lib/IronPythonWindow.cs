...
internal sealed class PythonWindowsConsoleHost : IronPythonLoader.ConsoleService
{
    ...
    */
    ...
    static int Main(string[] args)
    {
        if (args.Length == 0)
        {
            new PythonWindowsConsoleHost(null).PrintHelp();
            return 1;
        }

        return new PythonWindowsConsoleHost(null).Run(args);
    }
